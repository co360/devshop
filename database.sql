...
-- -----------------------------------------------------
-- Table `devshop`.`products_image`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `devshop`.`products_image` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_products_image_product_variations1_idx` (`product_variation_id` ASC) VISIBLE,
  CONSTRAINT `fk_products_image_product_variations1`
